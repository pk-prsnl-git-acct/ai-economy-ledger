...
export const publicRoutes = [
  ...
  { href: "/companies", label: "Companies", eyebrow: "Release-bound company profiles", title: "Five companies, with the limits attached.", description: "Compact profiles of current release membership and truth composition, explicitly not complete financial statements." },
