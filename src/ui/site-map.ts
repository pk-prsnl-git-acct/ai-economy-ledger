...
export const publicRoutes = [
  { href: "/", label: "Overview", eyebrow: "Source-linked AI economy intelligence", title: "See the companies, capital and infrastructure shaping the AI economy.", description: "A release-bound view of financial observations across five AI-stack layers, with evidence and limitations kept close." },
  { href: "/ai-stack", label: "AI Stack", eyebrow: "Five-layer product taxonomy", title: "Coverage starts with a clear map of the AI stack.", description: "See the five product layers, current company roles, observation coverage and the gaps this release does not fill." },
  { href: "/market", label: "Trends", eyebrow: "Release intelligence · limited universe", title: "Useful analysis begins with what the data cannot say.", description: "Release-bound trend views with trust, quality, coverage and unavailable states kept in the foreground." },
  { href: "/events", label: "Data Explorer", eyebrow: "Observation ledger · limited", title: "Read each observation without inventing a total.", description: "Official-filing observations retain their exact metric, period, review state and evidence-safe lineage." },
  { href: "/observations", label: "Data Explorer", eyebrow: "Observation ledger · limited", title: "Read each observation without inventing a total.", description: "Official-filing observations retain their exact metric, period, review state and evidence-safe lineage." },
  { href: "/relationships", label: "Relationships", eyebrow: "Evidence graph · unavailable", title: "No edge without evidence.", description: "Relationship and circularity analysis stays empty until the release contains public evidence-bound, directed economic edges." },
  { href: "/companies", label: "Companies", eyebrow: "Release-bound company profiles", title: "Company profiles, with the limits attached.", description: "Compact profiles of current release membership and truth composition, explicitly not complete financial statements." },
  ...
  { href: "/methodology", label: "Methodology", eyebrow: "Methods and definitions", title: "Trust comes from showing the method.", description: "Definitions, inclusion rules, source treatment and versioned calculation policies." },
  { href: "/sources", label: "Sources", eyebrow: "Evidence registry", title: "Trace every published observation to an official source.", description: "Release-bound official-source metadata, rights state and limitations." },
  { href: "/data", label: "Data", eyebrow: "Published release data", title: "Download the ledger without losing its caveats.", description: "A hash-verified published release bundle with separate source-attributed and verified lanes and explicit coverage." },
  { href: "/downloads", label: "Downloads", eyebrow: "Open data exports", title: "Reuse versioned ledger releases.", description: "Deterministic JSON and CSV artifacts with explicit trust lanes, integrity hashes, and coverage limitations." },
