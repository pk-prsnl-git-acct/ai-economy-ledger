...
export const publicRoutes = [
  ...
  { href: "/market", label: "Market Scope", eyebrow: "Release intelligence · limited universe", title: "Useful analysis begins with what the data cannot say.", description: "Release-bound market views with trust, quality, coverage and unavailable states kept in the foreground." },
  { href: "/events", label: "Observations", eyebrow: "Observation ledger · limited", title: "Read each observation without inventing a total.", description: "Official-filing observations retain their exact metric, period, review state and evidence-safe lineage." },
