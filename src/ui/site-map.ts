...
export const publicRoutes = [
  ...
  { href: "/market", label: "Market", eyebrow: "Release intelligence · limited universe", title: "Useful analysis begins with what the data cannot say.", description: "Release-bound market views with truth class, trust, quality, coverage, and unavailable states kept in the foreground." },
  { href: "/events", label: "Events", eyebrow: "Economic event ledger · limited", title: "Read each observation without inventing a total.", description: "Six source-attributed filing observations retain their exact metric, period, truth class, trust state, and evidence-safe lineage." },
