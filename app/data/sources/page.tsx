...
import { getSources } from "@/src/server/data-releases/runtime";
...
export default async function DataSourcesPage() {
  ...
  try {
    ...
    return <AppShell><HeroSection route={route} /><DataNavigation /><ReleaseUnavailablePanel surface="source manifest" /></AppShell>;
  }
