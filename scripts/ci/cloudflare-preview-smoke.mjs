...
try {
  ...
  const routeChecks = [
    ...
    ["/companies", ["Primary AI-stack layer", "Company details", "Published release"]],
    ["/companies/entity%3Acompany%3Aalphabet", ["Alphabet", "Company in current release", "Source-linked financial observations"]],
    ["/relationships", ["No edge without evidence", "does not draw a speculative network"]],
    ["/funding", ["Not yet supported by this release", "No released financing events", "View available observations"]],
    ["/revenue-debt", ["Not yet supported by this release", "Debt, obligations", "mixed financial values are not aggregated"]],
    ["/compute-infra", ["Not yet supported by this release", "No released compute-capacity", "not allocated infrastructure financial values"]],
    ["/circularity", ["Not yet supported by this release", "No released, evidence-bound directed economic relationships", "no circularity or adjusted-flow total"]],
