...
- Logical PR 8 is merged as GitHub PR `#9` in one combined scope including the former PR 8.5 admin bootstrap/RLS smoke checkpoint.
- Logical PR 9 is merged as GitHub PR `#10`; its hosted migration follow-up is also applied and recorded.
- Logical PR 10 is active on branch `agent/pr10-health-cron-readiness`.
